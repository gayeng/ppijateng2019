	...
	<br>
     ...
     <div class="row justify-content-md-center" >
        ...
        <div class="col-lg-1"><a class="button" href="<?php echo base_url('gameo'); ?>"><img src="<?php echo base_url(); ?>template/img/icon/gameonline.png" alt="Lights" class="img img-fluid">
         ...
         <div class="col-lg-1" align="center"><a class="button" href="<?php echo base_url('fotocom'); ?>"><img src="<?php echo base_url(); ?>template/img/icon/foto.png" alt="Lights" class="img img-fluid">
		</a></div>
